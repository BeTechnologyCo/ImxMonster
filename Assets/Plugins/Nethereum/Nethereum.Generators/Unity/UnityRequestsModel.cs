...
{
    public class UnityRequestsModel:TypeMessageModel
    {
        ...
        public UnityRequestsModel(ContractABI contractABI, string contractName, 
                            string byteCode, string @namespace, 
                            string cqsNamespace, string functionOutputNamespace):
            base(@namespace, contractName, "UnityRequests")
        {
