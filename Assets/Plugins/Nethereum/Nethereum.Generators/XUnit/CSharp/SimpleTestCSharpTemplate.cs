...
namespace Nethereum.Generators.XUnit
{
    public class SimpleTestCSharpTemplate : ClassTemplateBase<SimpleTestModel>
    {
        ...
        public override string GenerateClass()
        {
            return
                $@"
{SpaceUtils.OneTab}public class {Model.GetTypeName()}: NethereumIntegrationTest 
{SpaceUtils.OneTab}{{
{SpaceUtils.OneTab}
...
{SpaceUtils.TwoTabs}
{SpaceUtils.TwoTabs}public {Model.GetTypeName()}(ITestOutputHelper xunitTestOutputHelper) : base(""http://localhost:8545"",
